...
var video__container_OP = document.getElementById("video__container_OP");
var video__container1_OP = document.getElementById("video__container1_OP");
var contentvideo__loader1_OP = document.getElementById(
  "contentvideo__loader-1_OP"
);
var contentvideo__loader2_OP = document.getElementById(
  "contentvideo__loader-2_OP"
);

var video_OP = document.querySelector(".video_OP");
var video_InnerBar_OP = document.querySelector(".video__innerBar_OP");
var video_button_OP = document.getElementById("video__play-pause_OP");

var video1_OP = document.querySelector(".video1_OP");
var video_InnerBar1_OP = document.querySelector(".video__innerBar1_OP");
var video_button1_OP = document.getElementById("video__play-pause1_OP");

var contentvideo_loadercontainer1_OP = document.getElementById(
  "contentvideo_loadercontainer1_OP"
);
var contentvideo_loadercontainer2_OP = document.getElementById(
  "contentvideo_loadercontainer2_OP"
);

// bottle 1
var bottleContent__courvoisierSub_1_OP = document.getElementById(
  "bottleContent__courvoisier-3-1_OP"
);
var bottleContent__courvoisierSub_2_OP = document.getElementById(
  "bottleContent__courvoisier-3-2_OP"
);
var bottleContent__courvoisierSub_3_OP = document.getElementById(
  "bottleContent__courvoisier-3-3_OP"
);
var bottleContent__courvoisierSub_4_OP = document.getElementById(
  "bottleContent__courvoisier-3-4_OP"
);
var mainButton__content_OP = document.getElementById(
  "content-main-button__bottle1_OP"
);
var bottleContent__courvoisierMain_OP = document.getElementById(
  "bottleContent__courvoisier-3_OP"
);

// bottle 2
var bottleContent1__courvoisierSub_1_OP = document.getElementById(
  "bottleContent1__courvoisier-3-1_OP"
);
var bottleContent1__courvoisierSub_2_OP = document.getElementById(
  "bottleContent1__courvoisier-3-2_OP"
);
var bottleContent1__courvoisierSub_3_OP = document.getElementById(
  "bottleContent1__courvoisier-3-3_OP"
);
var bottleContent1__courvoisierSub_4_OP = document.getElementById(
  "bottleContent1__courvoisier-3-4_OP"
);
var mainButton__content1_OP = document.getElementById(
  "content-main-button1__bottle1_OP"
);
var bottleContent1__courvoisierMain_OP = document.getElementById(
...
function trigContent_OP() {
  ...
  contentvideo_loadercontainer2_OP.style.display = `none`;
  video__container1_OP.style.display = `none`;

  mainBottle__container2_OP = document.getElementById(
    "mainBottle__container-2_OP"
  );
  mainBottle__container2_OP.style.display = "block";

  mainBottle__container1_OP = document.getElementById(
  ...
  resetBottle1_OP();
  setTimeout(function() {
    var bottleLoaderContainer1_OP = document.getElementById(
    ...
    var bottleLoaderContainer2_OP = document.getElementById(
    ...
    var bottleLoaderContainer3_OP = document.getElementById(
    ...
    var bottleBaseImg_loadercontainer2_OP = document.getElementById(
      "bottleBaseImg_loadercontainer2_OP"
    );
...
function trigContent2_OP() {
  ...
  exploreBody.style.display = "none";
  explore_button2.style.display = "none";
  contentvideo_loadercontainer1_OP.style.display = `none`;
  video__container_OP.style.display = `none`;
  ...
  setTimeout(function() {
    ...
    var bottleBaseImg_loadercontainer2_OP = document.getElementById(
      "bottleBaseImg_loadercontainer1_OP"
    );
    bottleBaseImg_loadercontainer2_OP.style.width = "250px";
    bottleBaseImg_loadercontainer2_OP.style.transition = "1.5s";
  }, 200);
...
function resetBottle1_OP() {
  var bottleContent__courvoisier1_OP = document.getElementById(
    "bottleContent__courvoisier-1_OP"
  );
  bottleContent__courvoisier1_OP.style.display = `none`;
  var bottleContent__courvoisier2_OP = document.getElementById(
    "bottleContent__courvoisier-2_OP"
  );
  bottleContent__courvoisier2_OP.style.display = `none`;
  var bottleContent__courvoisier3_OP = document.getElementById(
    "bottleContent__courvoisier-3_OP"
  );
...
function resetBottle2_OP() {
  ...
  // content
  var bottleContent1__courvoisier1_OP = document.getElementById(
    "bottleContent1__courvoisier-1_OP"
  );
  bottleContent1__courvoisier1_OP.style.display = `none`;
  var bottleContent1__courvoisier2_OP = document.getElementById(
    "bottleContent1__courvoisier-2_OP"
  );
  bottleContent1__courvoisier2_OP.style.display = `none`;
  var bottleContent1__courvoisier3_OP = document.getElementById(
    "bottleContent1__courvoisier-3_OP"
  );
...
function Courvoisier_OP(input) {
  if (input == 0) {
    ...
    var bottleContent__courvoisier_OP = document.getElementById(
      "bottleContent__courvoisier-1_OP"
    );
    bottleContent__courvoisier_OP.style.display = `block`;
    var contentDetail__bottle1_OP = document.getElementById(
      "content-detail__bottle1_OP"
    );
    var contentImg__bottle1_OP = document.getElementById(
      "content-img__bottle1_OP"
    );
    ...
    var contentDetail__bottle1 = document.getElementById(
      "content-detail1__bottle1_OP"
    );
    var contentImg__bottle1 = document.getElementById(
      "content-img1__bottle1_OP"
    );
    ...
    loader.style.animation = `none`;
    var bottleContent__courvoisier = document.getElementById(
      "bottleContent2__courvoisier-2_OP"
    );
    bottleContent__courvoisier.style.display = `none`;

    var contentDetail__bottle1 = document.getElementById(
      "content-detail2__bottle1_OP"
    );
    var contentImg__bottle1 = document.getElementById(
      "content-img2__bottle1_OP"
    );
    ...
    loader.style.animation = `loader 1s linear infinite`;
    var bottleContent__courvoisier = document.getElementById(
      "bottleContent2__courvoisier-1_OP"
    );
    bottleContent__courvoisier.style.display = `block`;
    ...
    loader.style.animation = `none`;
    var bottleContent__courvoisier = document.getElementById(
      "bottleContent2__courvoisier-3_OP"
    );
    bottleContent__courvoisier.style.display = `none`;
...
function Artistry_OP(input) {
  if (input == 0) {
    ...
    contentvideo_loadercontainer1_OP.style.display = `block`;
    video__container_OP.style.display = `none`;
    contentvideo__loader1_OP.style.animation = ``;
    ...
    contentvideo_loadercontainer2_OP.style.display = `block`;
    video__container1_OP.style.display = `none`;
    contentvideo__loader2_OP.style.animation = ``;
...
function trigContentVideo_OP(input) {
  if (input == 0) {
    video__container_OP.style.display = `block`;
    contentvideo__loader1_OP.style.animation = `loader 1s linear infinite`;
    video_OP.load();
    play_OP.style.display = `block`;
    pause_OP.style.display = `none`;
  } else {
    video__container1_OP.style.display = `block`;
    contentvideo__loader2_OP.style.animation = `loader 1s linear infinite`;
    video1_OP.load();
    play1_OP.style.display = `block`;
    pause1_OP.style.display = `none`;
  }
}

// Video start here
function togglePlayPause_OP(input) {
  if (input == 0) {
    if (video_OP.paused) {
      var play_OP = document.getElementById("play_OP");
      play_OP.style.display = `none`;
      var pause_OP = document.getElementById("pause_OP");
      pause_OP.style.display = `block`;
      video_OP.play();
    } else {
      var play_OP = document.getElementById("play_OP");
      play_OP.style.display = `block`;
      var pause = document.getElementById("pause_OP");
      pause_OP.style.display = `none`;
      video_OP.pause();
    }
  } else {
    if (video1_OP.paused) {
      var play1_OP = document.getElementById("play1_OP");
      play1_OP.style.display = `none`;
      var pause1_OP = document.getElementById("pause1_OP");
      pause1_OP.style.display = `block`;
      video1_OP.play();
    } else {
      var play1_OP = document.getElementById("play1_OP");
      play1_OP.style.display = `block`;
...
video_button_OP.addEventListener("touchstart", function(e) {
  togglePlayPause_OP(0);
});

video_OP.addEventListener("timeupdate", function() {
  var innerbar__pos = video_OP.currentTime / video_OP.duration;
  video_InnerBar_OP.style.width = innerbar__pos * 100 + "%";
  if (video_OP.ended) {
    var play_OP = document.getElementById("play_OP");
    play_OP.style.display = `block`;
    var pause_OP = document.getElementById("pause_OP");
...
video_button1_OP.addEventListener("touchstart", function(e) {
  togglePlayPause_OP(1);
});

video1_OP.addEventListener("timeupdate", function() {
  var innerbar__pos = video1_OP.currentTime / video1_OP.duration;
  video_InnerBar1_OP.style.width = innerbar__pos * 100 + "%";
  if (video1_OP.ended) {
    var play1_OP = document.getElementById("play1_OP");
    play1_OP.style.display = `block`;
    var pause1_OP = document.getElementById("pause1_OP");
