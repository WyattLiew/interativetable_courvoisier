...
function startTapgameReadyTimer() {
  ...
  var tapGameReadyTimer = setInterval(function() {
    ...
    document.getElementById("tapgame__readytime").innerHTML =
      "&nbsp &nbsp" + seconds;
...
function startTapgameTimer() {
  ...
  var tapGameTimer = setInterval(function() {
    ...
    // Output the result in an element with id="demo"
    document.getElementById("tapgame__time").innerHTML =
      "0" + secs + ":" + tenth;
    ...
    if (secs < 1) {
      ...
      if (count > 47) {
        document.getElementById("tapgame__result").innerHTML =
          "Player A Win, <br> Loser drink!";
      } else if (count == 47) {
        document.getElementById(
          "tapgame__result"
        ).innerHTML = `&nbsp &nbsp &nbsp Draw!`;
      } else {
        document.getElementById("tapgame__result").innerHTML =
          "Player B Win, <br> Loser drink!";
      }
    }
