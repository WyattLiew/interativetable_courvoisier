...
(function(w) {
    ...
    var canvas_width = 1920; //Needs to be a multiple of the resolution value below.
    var canvas_height = 1080; //This too.
    
    var resolution = 20; //Width and height of each cell in the grid.
    
    var pen_size = 80; //Radius around the mouse cursor coordinates to reach when stirring
