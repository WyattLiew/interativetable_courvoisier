 // declare variable
    ...
    // bottle 1
    var bottleContent__courvoisierSub_1 = document.getElementById('bottleContent__courvoisier-3-1');
    var bottleContent__courvoisierSub_2 = document.getElementById('bottleContent__courvoisier-3-2');
    var bottleContent__courvoisierSub_3 = document.getElementById('bottleContent__courvoisier-3-3');
    var bottleContent__courvoisierSub_4 = document.getElementById('bottleContent__courvoisier-3-4');
    var mainButton__content = document.getElementById('content-main-button__bottle1');
    var bottleContent__courvoisierMain = document.getElementById('bottleContent__courvoisier-3');

    // bottle 2
    var bottleContent1__courvoisierSub_1 = document.getElementById('bottleContent1__courvoisier-3-1');
    var bottleContent1__courvoisierSub_2 = document.getElementById('bottleContent1__courvoisier-3-2');
    var bottleContent1__courvoisierSub_3 = document.getElementById('bottleContent1__courvoisier-3-3');
    var bottleContent1__courvoisierSub_4 = document.getElementById('bottleContent1__courvoisier-3-4');
    var mainButton__content1 = document.getElementById('content-main-button1__bottle1');
    var bottleContent1__courvoisierMain = document.getElementById('bottleContent1__courvoisier-3');

    // bottle 3
    var bottleContent2__courvoisierSub_1 = document.getElementById('bottleContent2__courvoisier-3-1');
    var bottleContent2__courvoisierSub_2 = document.getElementById('bottleContent2__courvoisier-3-2');
    var bottleContent2__courvoisierSub_3 = document.getElementById('bottleContent2__courvoisier-3-3');
    var bottleContent2__courvoisierSub_4 = document.getElementById('bottleContent2__courvoisier-3-4');
    var mainButton__content2 = document.getElementById('content-main-button2__bottle1');
    var bottleContent2__courvoisierMain = document.getElementById('bottleContent2__courvoisier-3');
    ...
    function trigContent() {
     ...
     var bottleLoaderContainer1 = document.getElementById('bottle1_loadercontainer1');
      ...
      var bottleBaseImg_loadercontainer2 = document.getElementById('bottleBaseImg_loadercontainer2');
    ...
    function trigContent2() {
     ...
     var bottleLoaderContainer1 = document.getElementById('bottle_loadercontainer1');
      ...
      var bottleBaseImg_loadercontainer2 = document.getElementById('bottleBaseImg_loadercontainer1');
      bottleBaseImg_loadercontainer2.style.width = '250px';
      bottleBaseImg_loadercontainer2.style.transition = '1.5s';
  },200)
  ...
  loader2_1.style.animation =`none`;
    ...
    function Courvoisier(input) {
      ...
      var contentDetail__bottle1 = document.getElementById("content-detail__bottle1");
      ...
      loader.style.animation =`none`;
      var bottleContent__courvoisier = document.getElementById('bottleContent1__courvoisier-2');
      bottleContent__courvoisier.style.display = `none`;

       var contentDetail__bottle1 = document.getElementById("content-detail1__bottle1");
      ...
      loader.style.animation =`loader 1s linear infinite`;
      var bottleContent__courvoisier = document.getElementById('bottleContent1__courvoisier-1');
      bottleContent__courvoisier.style.display = `block`;

       var loader = document.getElementById('bottleButton1__loader-3');
      loader.style.animation =`none`;
      var bottleContent__courvoisier = document.getElementById('bottleContent1__courvoisier-3');
      bottleContent__courvoisier.style.display = `none`;
      ...
      loader.style.animation =`none`;
      var bottleContent__courvoisier = document.getElementById('bottleContent2__courvoisier-2');
      bottleContent__courvoisier.style.display = `none`;

       var contentDetail__bottle1 = document.getElementById("content-detail2__bottle1");
      ...
      loader.style.animation =`loader 1s linear infinite`;
      var bottleContent__courvoisier = document.getElementById('bottleContent2__courvoisier-1');
      bottleContent__courvoisier.style.display = `block`;

       var loader = document.getElementById('bottleButton2__loader-3');
      loader.style.animation =`none`;
      var bottleContent__courvoisier = document.getElementById('bottleContent2__courvoisier-3');
      bottleContent__courvoisier.style.display = `none`;
